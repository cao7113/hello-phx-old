defmodule Hello.BlogTest do
  ...
  describe "posts" do
    ...
    @valid_attrs %{body: "some body", words_count: 42}
    @update_attrs %{body: "some updated body", words_count: 43}
    @invalid_attrs %{body: nil, words_count: nil}
  ...
  describe "comments" do
    ...
    @valid_attrs %{content: "some content", likes_count: 42}
    @update_attrs %{content: "some updated content", likes_count: 43}
    @invalid_attrs %{content: nil, likes_count: nil}
